...
const en = {
    ...
    p: {
        ...
        'user-tip1': 'This Passenger Service Agreement (hereinafter referred to as "this Agreement") is signed by you and Hong Kong Hi Transfers Limited. Hong Kong Hi Transfers Limited. is a company established under the laws of China (hereinafter referred to as "Hi Transfers" or "We").',
        'user-tip2': 'Statement',
        'user-tip3': `1.1 We are the exclusive cooperative marketing service provider of Hong Kong Hi Transfers Limited. (hereinafter referred to as “Hong Kong Hi Transfers Company”). The Hong Kong Hi Transfers Company is a company established under the laws of the People's Republic of China. It owns and operates the www.hiransfers.com. website (hereafter referred to as the "hiransfers website") and has legal authorization to own hiransfers software and products in China.`,
        'user-tip4': `1.2 After you have entrusted us to release the vehicle demand information to the third-party users of hitransfers software and products that are interested in serving you through hitransfers software and products, we will integrate the vehicle demand information provided by you and entrust the Hong Kong Hi Transfers Company to pass The hitransfers software and products are released and synthesized (hereinafter referred to as "our services").`,
        'user-tip5': `1.3 In order to provide you with our services, you will provide your name, gender, telephone number and other similar personal information and related property information (hereinafter referred to as “Personal Information”) required to register hitransfers software and products on a voluntary basis. You understand and accept the use of your personal information and agree that we and Hong Kong Hi Transfers Company will use your personal information to provide services to you. You may modify or delete the above information in accordance with the User Terms of Use of the Hong Kong Hi Transfers Company.`,
        ...
        'user-tip11': '3.2 We will integrate the information according to your vehicle requirements and publish the above information through the hitransfers software and products of Hong Kong Hi Transfers Company to provide you with matching services and matching services for third party service providers.',
        'user-tip12': '3.3 We will entrust Hong Kong Hi Transfers Company to inform you of the personal information of the relevant third party service providers assigned by hitransfers software and products.',
        ...
        'user-tip18': '4.2 You agree that Hong Kong Hi Transfers Company enjoys intellectual property rights and is protected by Chinese law regarding the use of hitransfers software and products in accordance with this Agreement. If there is no clear written right statement in the content of the hitransfers software and products, it does not mean that the Hong Kong Hi Transfers Company waives or does not claim rights. You shall respect the legitimate rights and interests of us and Hong Kong Hi Transfers Company in accordance with Chinese laws and regulations and the principle of good faith, and legally use hitransfers software and products.',
        'user-tip19': '4.3 You agree that you may not copy, modify, transcribe, transmit or otherwise misrepresent any part of your hitransfers software and products used in accordance with this Agreement without the written permission of Hong Kong Hi Transfers Company in any manner or manner. Bundled, sold, or hyperlinked or transmitted, stored in an information retrieval system, or used for any other commercial purpose, but downloaded or printed for non-commercial or personal use (unmodified, and must be retained) Except for copyright notices or other proprietary notices in the content.',
        'user-tip20': `4.4 You agree that the trademarks and logos (hereinafter referred to as "trademarks") in the hitransfers software and products that you use under this Agreement, whether registered or unregistered, are owned by the Hong Kong Hi Transfers Company or its affiliates in accordance with the law. Chinese legal protection. You may not use the hitransfers name and the trademarks or other marks of the hitransfers software and products in any way without the written permission of the Hong Kong Hi Transfers Company.`,
        ...
        'user-tip27': '6.2 Since our service entrusts Hong Kong Hi Transfers Company to publish your vehicle demand information through hitransfers software and products, in order for us to provide you with the above services, you agree to:',
        'user-tip28': `6.3 You will use the hitransfers software and products in accordance with the User Terms of Use of the Hong Kong Hi Transfers Company (www.hitransfers.com) (hereinafter referred to as “**hitransfers User Terms of Use**”);`,
        ...
        'user-tip33': '(5) When we or the Hong Kong Hi Transfers Company make a reasonable request, you will provide a formal and valid identification document;',
        ...
        'user-tip37': `7.1 In order to provide you with more accurate and personalized services, in the process of using your hitransfers products or services, Hong Kong Hi Transfers Company may collect and use the personal information you provide in the manner specified in this Agreement and share with you. Provide the personal information necessary for the service.`,
        'user-tip38': '7.2 If you provide personal information and proof to the Hong Kong Hi Transfers Company, you accept that Hong Kong Hi Transfers Company will collect, retain and use your information and certificates for the performance of this Agreement within the necessary time limit. Hong Kong Hi Transfers Company will strictly abide by the relevant laws and regulations of China in the collection, preservation and use of your personal information and materials and certificates. You can see how the Hong Kong Hi Transfers Company collects and uses your personal information and under what circumstances Hong Kong Hi Transfers Company may be in the privacy statement of the Hong Kong Hi Transfers Company included in the hitransfers User Terms of Use at www.hitransfers.com. Share or disclose such information. You agree that we may use the above information in accordance with the privacy statement of the Hong Kong Hi Transfers Company.',
        'user-tip39': '7.3 The scope of information collection. Your personal information below may be collected, stored and used by Hong Kong Hi Transfers Company, including but not limited to: personally identifiable information, contact information; geographical location information and destination information sent and stored by individuals through electronic devices; driving information; via hitransfers Itinerary information for software and product completion; other necessary information collected based on the needs of the specific service.',
        'user-tip40': '7.4 Privacy protection measures. For the personal information you provide to us, we will use a strict security system to ensure that it is not stolen or lost, not leaked, misused or altered. In order to better serve and upgrade our products, we may provide the data we obtain to third parties for analysis and statistics. It is also possible to use third-party products or services as we provide services. The above third-party companies or individuals will only be exposed to your personal information if necessary, and we will ensure that they are subject to strict confidentiality terms. 6According to Chinese laws and regulations or according to the orders of government departments, judicial organs or other law enforcement agencies or according to law, we or Hong Kong Hi Transfers Companies may need to provide the data we obtain to the above-mentioned government departments, judicial organs or other law enforcement agencies. ',
        ...
        'user-tip43': '8.2 Since the service we provide to you is to entrust Hong Kong Hi Transfers Company to publish your vehicle demand information through hitransfers software and products, therefore, when you choose to permanently delete the hitransfers software and products installed on your electronic terminal, we provide The service is also terminated. If you are terminated by the use of hitransfers software and products in violation of this Agreement or the use of hitransfers software and products, the services we provide will also terminate.',
        ...
        'user-tip47': '9.3 In the absence of any intentional or gross negligence of us or Hong Kong Hi Transfers Company, due to your use of hitransfers software and products, information linked by hitransfers software and products, or other website information linked to hitransfers software and products, You agree that we will be exempt from any breach of contract or tort liability if any loss or damage (including direct or indirect loss or damage, such as loss of income or profits, damage to the electronic terminal system or loss of data) caused by a third party. Under no circumstances will we or Hong Kong Hi Transfers Company be liable for no fault.',
        ...
        'user-tip49': '9.5 If you infringe or suffer damage to hitransfers software and products outside of China and obtain corresponding compensation or compensation according to the policies of our local related parties, you agree to waive to continue to us, Hong Kong Hi Transfers Company or us Or the related parties of the Hong Kong Hi Transfers Company further advocate any right to claim or compensate.',
        ...
        'user-tip56': '12.2 Change. We reserve the right to modify or replace the terms and conditions of this Agreement or to change, suspend or terminate the Services at any time. At that time, we only need to entrust the Hong Kong Hi Transfers Company to issue a notice or send a notice through the hitransfers software and product, and the above changes will be effective when the hitransfers website and/or the hitransfers software and products are issued for our notice. If you do not agree to such modification or replacement of this Agreement, you may terminate this Agreement in accordance with Section 8.2 of this Agreement. Your continued use of the hitransfers software and products will be deemed to have been agreed to the above modifications or replacements to this Agreement.',
        'user-tip57': '12.3 Notice. You agree that we may send you a notice by any of the following means:',
        'user-tip58': '(1) Entrusting Hong Kong Hi Transfers Company to issue announcement information through hitransfers software and products;',
